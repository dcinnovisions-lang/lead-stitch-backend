    ...
    try {
        ...
        for (let i = 0; i < recipients.length; i++) {
            ...
            try {
                ...
                console.log(`❌ [TRACKING] Email failed - Campaign: ${campaignId}, Recipient: ${recipientData.id}, Email: ${recipientData.email}`);
                console.log(`📡 [REALTIME] Triggering real-time update for failure - Campaign: ${campaignId}, Recipient: ${recipientData.id}`);
